class Constants {
  ...
  static const String validationErrorText = 'Ocurrió un error en la validación';
  static const String digitLengthErrorText = 'El codigo debe contener 4 digitos';
  static const String productErrorText = 'Ocurrió un error al obtener los productos';
  static const String errorText = 'errors';
  static const String fileErrorText = 'Ocurrió un error al obtener el archivo';

  // On boarding
  static const String onBoardingText = 'Para resolverte cualquier duda, asesorarte si tienes un accidente, ayudarte a conseguir un médico o hablar con tu aseguradora.';
  static const String onBoardingTwoText = 'Te diremos qué necesitas para protegerte y si no sabes cómo obtenerlos, te acercaremos a los beneficios más accesibles en México.';
  static const String personalAssistanceText = 'Asistencia personal';
  ...
  //Sub title texts
  static const String securityCodeText = 'Recibirás un codigo de seguridad al número';
